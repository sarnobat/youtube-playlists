...
cat youtube_playlist_items_output.txt | jq -r '.items[] | .snippet.playlistId +  "\thttps://www.youtube.com/watch?v=" + .contentDetails.videoId + "\t"  + "\t" + .snippet.title' | tee playlists.txt
