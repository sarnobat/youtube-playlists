...
cat youtube_playlist_items_output.txt | jq -r '.items[] | "https://www.youtube.com/watch?v=" + .contentDetails.videoId + "\t" + .snippet.playlistId  + "\t" + .snippet.title' | tee playlists.txt
